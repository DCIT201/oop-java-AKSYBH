...
public class RentalAgency {
    ...
    public void returnVehicle(UUID rentalTransactionId) {
        ...
        if(vehicle != null) {
            ...
            finaliseTransaction(rentalTransactionId, RentalTransaction.RentalStatus.RETURNED);
        }else {
    ...
    public void cancelRental(UUID transactionId) {
        ...
        finaliseTransaction(transactionId, RentalTransaction.RentalStatus.CANCELLED);
    }
